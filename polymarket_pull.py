...
CATEGORY_RULES = [
    ...
    ("Finance", [
        r"\b(acquire|acquisition|merger|merged|ipo|will.*acquire|will.*merge|buyout|takeover)\b",
        r"\b(bankruptcy|bankrupt|bail.?out|bank run|bank fail)\b",
    ]),
    ("Economics", [
        ...
        r"\b(jobs report|nonfarm payrolls|unemployment rate)\b",
        r"\b(s&p 500|dow jones|nasdaq|stock market|cpi|ppi)\b",
        r"\b(oil price|commodity|housing market|home prices)\b",
